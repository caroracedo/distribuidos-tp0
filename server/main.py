...
def initialize_config():
    ...
    try:
        ...
        config_params["total_agencies"] = int(
            os.getenv("TOTAL_AGENCIES", config["DEFAULT"].get("TOTAL_AGENCIES", 0))
        )
...
def main():
    ...
    logging.debug(
        ...
        f"listen_backlog: {listen_backlog} | logging_level: {logging_level} | total_agencies: {total_agencies}"
    )
